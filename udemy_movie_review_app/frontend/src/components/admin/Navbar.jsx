...
//already have navbar inside the user folder

//already made logout in AuthProvider,
//which can be accessed from the hook in hooks
//need to deconstruct that to get that function
//and then need to activate that from a onClick event
